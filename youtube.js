...
//         SearchBar.value = 'Error occurred: ' + event.error;
...
//       SearchBar.value = 'Speech recognition not supported in this browser.';
...
// {
//   let Response =  await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&q=${SearchData}&key=AIzaSyBGC99QpchtEbMXV6jbRVZZZSUSK_qq_8A`);
...
// Initial call to populate videos for the default search term "India"
Get("India");
...
// Call the setupSpeechToText function to set up speech recognition
setupSpeechToText();